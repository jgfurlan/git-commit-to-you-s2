...
export function SanctuaryHome({
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-between pb-24 bg-[#040305] text-[#FAF6EE] overflow-x-hidden select-none">
      {/* 1. Névoa Volumétrica Animada */}
      <FogCanvas />

      {/* 2. Vinheta Gótica Profunda */}
      <VignetteOverlay />

      {/* Cabeçalho do Santuário */}
      <header className="relative z-20 w-full max-w-md flex items-center justify-between px-6 pt-5 pb-3 border-b border-[#C9A86A]/20">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-full border border-[#C9A86A] bg-[#120F17] flex items-center justify-center shadow-[0_0_12px_rgba(201,168,106,0.3)]">
      ...
      {/* Conteúdo Principal */}
      <main className="relative z-20 w-full max-w-md px-6 py-4 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center my-3">
          ...
          <h2 className="font-cinzel text-xl sm:text-2xl font-bold tracking-wider text-[#FAF6EE] mb-2">
            A Guardiã
          </h2>

          {/* Orbe Mística com Penumbra e Chamas */}
          <div className="relative w-36 h-36 flex items-center justify-center my-1">
            ...
            {/* Núcleo da Orbe */}
            <div 
              className="relative w-28 h-28 rounded-full bg-gradient-to-br from-[#120F17] via-[#2B3B4E] to-[#08070A] border-2 border-[#E5C384] shadow-[0_0_35px_rgba(201,168,106,0.35)] flex flex-col items-center justify-center p-2 text-center"
            >
              <div className="w-8 h-8 rounded-full bg-[#7A0C1E]/90 border border-[#E5C384] flex items-center justify-center mb-1">
          ...
          <p className="font-garamond italic text-xs text-[#FAF6EE]/70 max-w-xs mt-1">
            &ldquo;Sussurre à Guardiã através da névoa para desvelar uma memória guardada.&rdquo;
          </p>
        </div>

        {/* Card do Pergaminho da Memória do Dia */}
        <div 
          className="relative w-full rounded-lg p-5 my-3 border border-[#C9A86A]/40 text-stone-900 shadow-[0_20px_50px_rgba(0,0,0,0.9)]"
          style={{
        ...
        <div className="w-full grid grid-cols-3 gap-2.5 my-2">
          <div className="p-3 rounded-lg bg-[#120F17]/90 border border-[#C9A86A]/30 text-center flex flex-col items-center shadow-md">
        ...
        <div className="w-full mt-2">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            <div className="p-3 rounded-lg bg-[#120F17]/90 border border-[#2B3B4E] flex items-center gap-2.5 shadow-md">
            ...
            <div className="p-3 rounded-lg bg-[#120F17]/90 border border-[#2B3B4E] flex items-center gap-2.5 shadow-md">
              <div className="w-9 h-9 rounded-full bg-[#2B3B4E] border border-[#E5C384] flex items-center justify-center shrink-0 shadow-[0_0_10px_#3D5470]">
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-30 bg-[#040305]/95 border-t border-[#C9A86A]/20 backdrop-blur-md py-2.5 px-6 flex items-center justify-around max-w-md mx-auto shadow-2xl">
        <button
